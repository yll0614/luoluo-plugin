...
export class setting extends plugin {
    constructor() {
        super({
            ...
            rule: [
                {
                    reg: `^#?(ll|LL|Ll|lL|luoluo|落落|luoluo插件|ll插件|LL插件|Ll插件|lL插件)(设置|修改)(一言|疯狂星期四|网易云热评|天气|歌曲类|唱鸭|随机表情包|攻受短文|ping地址|谁艾特我|是什么垃圾|随机动漫图|哔哩哔哩热搜榜|知乎热搜榜|抖音热搜榜|今日头条热搜榜|今日头条热点新闻|生成二维码|头像|群头像|举牌|网页截图|哔哩哔哩解析|更新推送)(开启|关闭)$`,
                    fnc: 'setting',
    ...
    async setting(e) {
        ...
        let reg = new RegExp(`(一言|疯狂星期四|网易云热评|天气|歌曲类|唱鸭|随机表情包|攻受短文|ping地址|谁艾特我|是什么垃圾|随机动漫图|哔哩哔哩热搜榜|知乎热搜榜|抖音热搜榜|今日头条热搜榜|今日头条热点新闻|生成二维码|头像|群头像|举牌|网页截图|哔哩哔哩解析|更新推送)(开启|关闭)`).exec(e.msg);
        if (!reg) {
            e.reply('命令格式错误或未匹配');
            return false;
        }
