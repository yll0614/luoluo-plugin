...
export const settinghelpList = [
  {
    ...
    list: [
        ...
        {
            "icon": 55,
            "title": "#落落设置疯狂星期四开启/关闭",
            "desc": "开启/关闭疯狂星期四 默认开启"
        },
        {
            "icon": 48,
            "title": "#落落设置网易云热评开启/关闭",
        ...
        {
            "icon": 134,
            "title": "#落落设置随机动漫图开启/关闭",
            "desc": "开启/关闭随机动漫图 默认开启"
        },
        {
            "icon": 111,
            "title": "#落落设置哔哩哔哩热搜榜开启/关闭",
            "desc": "开启/关闭哔哩哔哩热搜榜 默认开启"
        },
        {
            "icon": 78,
            "title": "#落落设置知乎热搜榜开启/关闭",
            "desc": "开启/关闭知乎热搜榜 默认开启"
        },
        {
            "icon": 91,
            "title": "#落落设置抖音热搜榜开启/关闭",
            "desc": "开启/关闭抖音热搜榜 默认开启"
        },
        {
            "icon": 99,
            "title": "#落落设置今日头条热搜榜开启/关闭",
